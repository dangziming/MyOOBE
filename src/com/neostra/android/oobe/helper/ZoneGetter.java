...
public class ZoneGetter {
    ...
    private static Map<String, Object> createDisplayEntry(
        ...
        Log.d(TAG, "tz.getID():" + tz.getID() + ", displayName.toString():" + displayName.toString() + ", displayName:" + displayName + ", gmtOffsetText.toString():" + gmtOffsetText.toString() + ", gmtOffsetText:" + gmtOffsetText + ", offsetMillis:" + offsetMillis);
        return map;
    }
